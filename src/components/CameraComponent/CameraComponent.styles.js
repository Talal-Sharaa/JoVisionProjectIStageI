        ...
        try {
          ...
          const readStorageGranted = await PermissionsAndroid.request(
            PermissionsAndroid.PERMISSIONS.READ_EXTERNAL_STORAGE,
            {
              ...
              message:
                'This app needs read access to your storage to display photos',
              buttonNeutral: 'Ask Me Later',
              buttonNegative: 'Cancel',
              buttonPositive: 'OK',
            },
          ...
          if (readStorageGranted !== PermissionsAndroid.RESULTS.GRANTED) {
  ...
  const savePhoto = async () => {
    if (photo) {
      ...
      try {
        ...
        await RNFS.copyFile(photo, filePath);  // Use copyFile instead of moveFile
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('Gallery', { photos: savedPhotos })}
      >
